...
def main():
    parser = argparse.ArgumentParser(description="Fetch interactions for use in a pandas dataframe.")
    parser.add_argument(
        'gene_list', 
        type=int, 
        nargs='+', 
        help='A list of gene IDs to search for'
    )
    parser.add_argument(
        '--output_folder',
        type=str,
        default='.',
        help='The folder where the output CSV file will be saved'
    )
